...
$menu = wofi --show drun
$cmenu = wofi --show run
$music = flatpak run --socket=wayland --own-name=org.mpris.MediaPlayer2.cider sh.cider.genten --ozone-platform-hint=auto --enable-features=WaylandWindowDecorations
