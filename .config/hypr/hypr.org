...
Tokyo Night colours
#+begin_src conf
$bgHighlight = rgb(292e42)
$bgHighlightAlpha = 292e42
...
$terminalBlack = rgb(414868)
$terminalBlackAlpha = 414868
...
general {
    ...
    col.inactive_border = $terminalBlack
    layout = dwindle
    allow_tearing = false
}
